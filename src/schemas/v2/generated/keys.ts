...
const Goal = [] as const
const Media = ['closed_captions_enabled', 'closed_captions', 'created_at', 'display', 'download_url', 'file_name', 'image_urls', 'media_type', 'metadata', 'mimetype', 'owner_id', 'owner_relationship', 'owner_type', 'size_bytes', 'state', 'upload_expires_at', 'upload_parameters', 'upload_url'] as const

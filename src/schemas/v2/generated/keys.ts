...
const Member = ['campaign_lifetime_support_cents', 'currently_entitled_amount_cents', 'email', 'full_name', 'is_follower', 'last_charge_date', 'last_charge_status', 'lifetime_support_cents', 'next_charge_date', 'note', 'patron_status', 'pledge_cadence', 'pledge_relationship_start', 'will_pay_amount_cents'] as const
const OauthClient = ['author_name', 'client_secret', 'default_scopes', 'description', 'domain', 'icon_url', 'name', 'privacy_policy_url', 'redirect_uris', 'tos_url', 'version'] as const
const PledgeEvent = ['amount_cents', 'currency_code', 'date', 'payment_status', 'tier_id', 'tier_title', 'type'] as const
